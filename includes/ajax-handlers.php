 ...
 */
if (!function_exists('kwetupizza_test_whatsapp_ajax')) {
 ...
 */
if (!function_exists('kwetupizza_test_sms_ajax')) {
 ...
 */
if (!function_exists('kwetupizza_process_order_ajax')) {
 ...
 */
if (!function_exists('kwetupizza_update_cart_ajax')) {
 ...
 */
if (!function_exists('kwetupizza_calculate_delivery_ajax')) {
